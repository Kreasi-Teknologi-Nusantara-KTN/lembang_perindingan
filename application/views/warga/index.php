      ...
      <div class="card">
        <div class="card-header">
          <div class="tm-section-header section-margin-top">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6"><h2 class="tm-section-title">Data Warga</h2></div>
            <div class="col-lg-4 col-md-3 col-sm-3"><hr></div>	
          </div>
        </div>
        <div class="card-body">
          <a class="btn btn-success mb-3" href="<?= base_url(); ?>warga/cetak.html" target="_blank">Cetak</a>
